    ...
    const previewButtonErrorAlert = getTagByString(`
        <div id="preview-button-error-alert" style="
                        ...
                        <div style="flex: 1;">
                            ...
                            <div style="font-size: 13px; color: #333;">Due to recent changes to GitHub's layout, the preview button is temporarily disabled.<br/>Use Ctrl + Shift + Y (Windows/Linux) or Command + Shift + Y (Mac), or right-click and select "Preview HTML" from the context menu.</div>
                        </div>
                    </div>
        `);
